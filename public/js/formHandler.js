...
{$form.append("<div id='form-alert'><div class='alert alert-danger'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button><strong>Il semble que notre serveur mail ne réponde pas.Toutes nos excuses pour le désagrément!</strong></div></div>")}},})}},filter:function()
